...
for s = 1, screen.count() do
   -- Cada tela possui sua propria tabela de tags (no caso de multiplos
   -- monitores).
...
myawesomemenu = {
   ...
   { "editar awesomerc", editor_cmd .. " " .. awesome.conffile },
...
globalkeys = awful.util.table.join(
   ...
   awful.key({ modkey,           }, "w", function () meuMenuPrincipal:show({keygrabber=true}) end),
